export const weeklyColumns = [
    {
        ...
        sections: [
            ...
            },
            {
                ...
                paragraphs: ['The middle division consists of Brittany’s Badkittens, Dustin’s Austin’s Finest, Brandon’s Skip’s Picks, and Wesley’s Warren’s World. Brittany drops from First Class, while Dustin stays exactly where he was. Brandon and Wesley both move up from Level 11 after earning playoff places without advancing to the semifinals.', 'This may be the league’s most volatile division. It includes two returning playoff teams, a former First Class resident, and Dustin—the sort of combination that can look orderly in August and become a four-car pileup by October. The name still asks whether anyone remembers who belongs here. The standings will eventually provide an answer, probably impolitely.'],
                bullets: ['Brittany — Badkittens: relegated from First Class.', 'Dustin — Austin’s Finest: remains in What’s Your Name Again?.', 'Brandon — Skip’s Picks: promoted from Level 11 after making the playoffs.', 'Wesley — Warren’s World: promoted from Level 11 after making the playoffs.'],
            },
            {
